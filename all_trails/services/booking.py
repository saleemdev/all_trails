...
def serialize_booking(booking: dict[str, Any] | frappe.model.document.Document) -> dict[str, Any]:
	...
	result = {
		...
		"trail_county": row.trail_county,
		"trail_scheduled_date": row.trail_scheduled_date,
		"trail_start_time": row.trail_start_time,
		"trail_end_time": row.trail_end_time,
		"trail_meeting_point": row.trail_meeting_point,
		"trail_meeting_time": row.trail_meeting_time,
		"trail_difficulty_level": row.trail_difficulty_level,
		"trail_type": row.trail_type,
		"trail_distance_km": flt(row.trail_distance_km),
		"trail_duration_hours": flt(row.trail_duration_hours),
		"trail_elevation_gain_m": cint(row.trail_elevation_gain_m),
		"trail_altitude_max_m": cint(row.trail_altitude_max_m) if row.trail_altitude_max_m is not None else None,
		"trail_fitness_level": row.trail_fitness_level,
		"trail_water_requirement_litres": flt(row.trail_water_requirement_litres) if row.trail_water_requirement_litres is not None else None,
		"trail_terrain_summary": row.trail_terrain_summary,
		"trail_transport_notes": row.trail_transport_notes,
		"trail_packing_list": row.trail_packing_list,
		"trail_safety_notes": row.trail_safety_notes,
		...
		booking = frappe.get_doc(
			{
				...
				"trail_county": trail.county,
				"trail_scheduled_date": trail.scheduled_date,
				"trail_start_time": trail.start_time,
				"trail_end_time": trail.end_time,
				"trail_meeting_point": trail.meeting_point,
				"trail_meeting_time": trail.meeting_time,
				"trail_difficulty_level": trail.difficulty_level,
				"trail_type": trail.trail_type,
				"trail_distance_km": trail.distance_km,
				"trail_duration_hours": trail.duration_hours,
				"trail_elevation_gain_m": trail.elevation_gain_m,
				"trail_altitude_max_m": trail.altitude_max_m,
				"trail_fitness_level": trail.fitness_level,
				"trail_water_requirement_litres": trail.water_requirement_litres,
				"trail_terrain_summary": trail.terrain_summary,
				"trail_transport_notes": trail.transport_notes,
				"trail_packing_list": trail.packing_list,
				"trail_safety_notes": trail.safety_notes,
