...
class ApiService {
  ...
  private normalizeBooking(raw: any): TrailBooking {
    ...
    return {
      ...
      trail_county: raw.trail_county || undefined,
      trail_scheduled_date: raw.trail_scheduled_date || undefined,
      trail_start_time: raw.trail_start_time || undefined,
      trail_end_time: raw.trail_end_time || undefined,
      trail_meeting_point: raw.trail_meeting_point || undefined,
      trail_meeting_time: raw.trail_meeting_time || undefined,
      trail_difficulty_level: raw.trail_difficulty_level || undefined,
      trail_type: raw.trail_type || undefined,
      trail_distance_km: raw.trail_distance_km === undefined || raw.trail_distance_km === null ? undefined : Number(raw.trail_distance_km),
      trail_duration_hours: raw.trail_duration_hours === undefined || raw.trail_duration_hours === null ? undefined : Number(raw.trail_duration_hours),
      trail_elevation_gain_m: raw.trail_elevation_gain_m === undefined || raw.trail_elevation_gain_m === null ? undefined : Number(raw.trail_elevation_gain_m),
      trail_altitude_max_m: raw.trail_altitude_max_m === undefined || raw.trail_altitude_max_m === null ? undefined : Number(raw.trail_altitude_max_m),
      trail_fitness_level: raw.trail_fitness_level || undefined,
      trail_water_requirement_litres:
        raw.trail_water_requirement_litres === undefined || raw.trail_water_requirement_litres === null
          ? undefined
          : Number(raw.trail_water_requirement_litres),
      trail_terrain_summary: raw.trail_terrain_summary || undefined,
      trail_transport_notes: raw.trail_transport_notes || undefined,
      trail_packing_list: raw.trail_packing_list || undefined,
      trail_safety_notes: raw.trail_safety_notes || undefined,
